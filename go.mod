...
replace modernc.org/sqlite => modernc.org/sqlite v1.34.1

replace modernc.org/libc => modernc.org/libc v1.55.3
...
require (
	...
	go.temporal.io/server v1.29.0-135.0.0.20260122143029-f0bb0a2519ae
